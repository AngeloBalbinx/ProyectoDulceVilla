...
public class Logueo extends JFrame implements ActionListener {
	...
	// usuario púbblico para acceder al método
	...
	private void ValidarAcceso() {
		...
		user = getUsuario();
		clave = getClave();
		// Validación para que se ingresen los datos
		if(user ==null || clave == null){
			return;
		}else{// si ingresaron el user y la contraseña
	...
	private void mensajeExito(String msj) {
		JOptionPane.showMessageDialog(this, msj, "Éxito!", 1);
