...
public class validaciones {
	...
	//public static final String APELLIDO = "[a-zA-ZáéíóúÁÉÍÓÚÑñ\\s] {2,25}";
	//public static final String USUARIO = "[a-zA-ZáéíóúÁÉÍÓÚÑñ\\s\\d] {4}";
	//public static final String CLAVE= "[a-zA-ZáéíóúÁÉÍÓÚÑñ\\s\\d] {5}";
